...
export default function IndexPage() {
  ...
  return (
    <div
      className="flex flex-col items-center justify-center min-h-screen w-full space-y-8 inset-0"
      style={{
    ...
    >
      ...
      <div className="bg-gray-100 p-8 rounded-lg shadow-lg text-center flex flex-col items-center md:max-w-[25vw] md:min-h-[70vh] z-40">
        ...
        <p className="text-gray-700 mb-8 font-bold">
          NOTE: Demo version does not have saving recipe functionality or page!
          Please connect with Google for the full experience!
        </p>
